				...
				<div class="card-body bd bd-t-0 rounded-bottom">
					<form action="{{ route('units.store')}}" method="POST">
						...
						<div class="form-group">
							<label class="form-control-label">Name Units: <span class="tx-danger">*</span></label>
						...
						<table id="datatable1" class="table display responsive nowrap">
							...
							<tbody>
								...
								<tr>
									...
									<td>
									<form action="{{route('units.destroy',$rows->id)}}" method="POST">
			                    @csrf
			                    @method('DELETE')
			                    <a href="{{route('units.edit', $rows->id)}}" class="btn btn-warning btn-xs btn-outline">Edit</a>
