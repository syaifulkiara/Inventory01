				...
				<div class="card-body bd bd-t-0 rounded-bottom">
					<form action="{{ route('categories.store')}}" method="POST">
						...
						<div class="form-group">
							<label class="form-control-label">Name Category: <span class="tx-danger">*</span></label>
						...
						<table id="datatable1" class="table display responsive nowrap">
							...
							<tbody>
								...
								<tr>
				                    ...
				                    @csrf
				                    @method('DELETE')
				                    <a href="{{route('categories.edit', $rows->id)}}" class="btn btn-warning btn-xs btn-outline">Edit</a>
